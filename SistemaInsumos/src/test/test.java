...
//		System.out.println();
//		
//		System.out.println(PedidoABM.getInstanciaPedidoABM().traer(2).calcularTotal());
//		
//		System.out.println();
//		
//		System.out.println(AreaABM.getInstanciaAreaABM().traer("Sistemas").calcularPresupuesto(LocalDate.of(2000, 10, 22), LocalDate.of(2030, 10, 22)));
//		
